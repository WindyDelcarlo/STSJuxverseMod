...
public class FlowPower extends BasePower {
    ...
    public static final String POWER_ID = makeID("FlowPower");
    ...
    public void onUseCard(AbstractCard card, UseCardAction action){
        if(!card.purgeOnUse && card.type == AbstractCard.CardType.SKILL && this.amount > 0){
            ...
            this.amount--;
            if (this.amount == 0) addToTop((AbstractGameAction) new RemoveSpecificPowerAction(this.owner,this.owner,FlowPower.POWER_ID));
